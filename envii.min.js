...
function Frame(t,s,i){this.width=width,this.height=s,this.depth=i}function explode_infinite(t,s,i,e,h){void 0===e&&(e=1),void 0===h&&(h=0),this.side=t,this.distance=s,this.scale=i,this.speed=e/100}function rotateY(t,s){void 0===s&&(s=1),this.side=t,this.speed=s,this.state=0}function move(t,s,i,e){this.x=t,this.y=s,this.z=i,this.speed=e,this.state=1,this.max=5e6,this.firstTime=!0,this.sign=function(t){return t>0?1:0>t?-1:0}}function planeXTransform(t,s,i,e){void 0===i&&(i=1),void 0===e&&(e=0),this.distance=t,this.scale=s,this.speed=i,this.state=e}function planeWave(t,s,i){this.state=1,this.speed=t,this.width=s,this.depth=i}function house_fly(t,s,i){void 0===i&&(i=!1),this.speed=t,this.range=s,this.slave=i,this.direction=[1,1,1]}explode_infinite.prototype.processPoint=function(t,s,i){for(var e=0;e<s.length-1;e+=1)s[e]>this.side*i.scale/2?s[e]=s[e]+this.scale*this.state:s[e]==this.side*i.scale/2||(s[e]=s[e]-this.scale*this.state);return 1e7>this.state?this.state+=1*this.speed:this.state=0,s},rotateY.prototype.processPoint=function(t,s,i){var e=this.side/2*i.scale,h=(this.half-s[0])/e,o=(this.half-s[2])/e,a=h*this.side*(this.state/1e3);s[0]=s[0]*a;var n=o*this.side*(this.state/1e3);return s[2]=s[0]*n,this.state<1e3?this.state+=1*this.speed:(console.log("half: "+e),console.log("point[0]; "+s[0]),console.log("deltaX: "+h),console.log("rotX: "+a),this.state=0),s},move.prototype.processPoint=function(t,s,i){return this.firstTime&&(this.dx=this.x-i.xpos,this.dy=this.y-i.ypos,this.dz=this.z-i.zpos,this.firstTime=!1),s[0]=s[0]+this.dx*(this.state/this.max)*this.speed,s[1]=s[1]+this.dy*(this.state/this.max)*this.speed,s[2]=s[2]+this.dz*(this.state/this.max)*this.speed,this.state+=1,s},planeWave.prototype.processPoint=function(t,s,i){return s[0]==this.state?s[2]=s[2]+this.depth:(s[1]==this.state||s[-1]==this.state)&&(s[2]=s[2]+this.depth/2),i.width>this.state?this.state+=1*this.speed:this.state=1,s},planeWave.prototype.processGeo=function(t){for(var s=this.state/t.scale,i=[],e=0;e<t.geo.length;e+=1){var h=t.geo[e];h[0]==s?h[2]=h[2]+this.depth:(h[1]==s||h[-1]==s)&&(h[2]=h[2]+this.depth/2),i[i.length]=[h]}return t.width>s?this.state+=1*this.speed:this.state=1,i},house_fly.prototype.processPoint=function(t,s){if(0==this.slave)for(var i=0;i<t.pos.length;i+=1){var e=Math.abs(s[i]/2-t.pos[i]);e<s[i]/2*Math.max(.4,Math.random())?t.pos[i]=t.pos[i]+Math.random()*this.speed*this.direction[i]:this.direction[i]=-1*this.direction[i]}};
